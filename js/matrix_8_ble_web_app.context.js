...
export const state = {
  ...
  selectedFrame: -1,
  activeAnimationName: "",
  activeAnimationCanAddFrames: false,
  textDirection: "left",
...
export const ui = {
  ...
  sendImgBtnLabel: document.getElementById("sendImgBtnLabel"),
  ...
  animPresetModalPreviewGrid: document.getElementById("animPresetModalPreviewGrid"),
  ...
  createAnimModal: document.getElementById("createAnimModal"),
  createAnimNameInput: document.getElementById("createAnimNameInput"),
  createAnimNameError: document.getElementById("createAnimNameError"),
  createAnimCancelBtn: document.getElementById("createAnimCancelBtn"),
  createAnimCreateBtn: document.getElementById("createAnimCreateBtn"),
  addFrameModal: document.getElementById("addFrameModal"),
  addFrameTitle: document.getElementById("addFrameTitle"),
  ...
  addFrameClearBtn: document.getElementById("addFrameClearBtn"),
  addFrameFillBtn: document.getElementById("addFrameFillBtn"),
  addFrameInvertBtn: document.getElementById("addFrameInvertBtn"),
  addFrameRotateBtn: document.getElementById("addFrameRotateBtn"),
  addFrameCancelBtn: document.getElementById("addFrameCancelBtn"),
  addFrameDeleteBtn: document.getElementById("addFrameDeleteBtn"),
